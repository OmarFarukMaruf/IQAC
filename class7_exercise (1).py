...
print("Before adding school details: ", (len(village_school)))
print(end='\n')
...
print("After adding school details: ", (len(village_school)))
print(end='\n')
...
dict_1 = {}
for value in village_school.values():
    # if value == 'Founder of Toto Company':
    #     village_school.popitem(value)
    #     print(vars())
    if type(value) == list:
        valueList = value
        print(valueList)
...
for dic in managing_committee_caniddates:
    print(dic)
...
print(students1.difference(students2))